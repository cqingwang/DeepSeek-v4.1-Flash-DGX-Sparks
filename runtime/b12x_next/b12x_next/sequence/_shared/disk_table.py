...
class DiskRowCache:
    ...
    def __init__(
        ...
        *,
        ...
        from b12x_next.loader._native import load
        ...
        self._backend = os.environ.get("B12X_NEXT_DISK_BACKEND", "io_uring")
        if self._backend not in ("io_uring", "gds"):
            raise ValueError("B12X_NEXT_DISK_BACKEND must be io_uring or gds")
        self._gds = None
        self._native = None
        self._reader = None
