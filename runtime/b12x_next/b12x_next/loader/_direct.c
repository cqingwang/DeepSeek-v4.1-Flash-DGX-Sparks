...
static void delete_reader(PyObject *capsule) {
    direct_reader_t *reader = PyCapsule_GetPointer(capsule, "b12x_next.direct_reader");
    if (!reader) return;
    free(reader->scratch);
...
static PyObject *py_direct_reader(PyObject *self, PyObject *args) {
    ...
    PyObject *capsule = PyCapsule_New(reader, "b12x_next.direct_reader", delete_reader);
