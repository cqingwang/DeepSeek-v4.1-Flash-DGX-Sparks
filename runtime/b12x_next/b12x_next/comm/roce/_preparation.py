...
from b12x_next.preparation import FrozenMapping, MemoryRequirements, Plan, PreparedCall
...
def plan(
    ...
    *,
    ...
    def jobs(config, device):
        return (
            CompileJob.create(
                "b12x_next.comm.roce._preparation:compile_roce", payload, device.ordinal
            ),
        )
