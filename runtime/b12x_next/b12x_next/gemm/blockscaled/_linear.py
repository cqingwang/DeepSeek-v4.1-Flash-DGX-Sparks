"""Packed-weight adapters for the public :mod:`b12x_next.gemm.blockscaled` API."""
...
@torch.library.custom_op(
    "b12x_next::blockscaled_serialized",
    mutates_args=(),
...
@torch.library.custom_op(
    "b12x_next::blockscaled_packed_mxfp8",
    mutates_args=(),
)
...
@torch.library.custom_op(
    "b12x_next::blockscaled_packed_mxfp8_prequantized",
    mutates_args=(),
    tags=(torch.Tag.needs_fixed_stride_order,),
)
...
def mxfp8_linear(
    ...
    *,
    ...
    if tokens == 0:
        ...
        assert source_scale is not None
        output = torch.ops.b12x_next.blockscaled_packed_mxfp8_prequantized(
            source_2d,
            source_scale,
        ...
        output = torch.ops.b12x_next.blockscaled_packed_mxfp8(
            source_2d,
            packed_weight.weight.values,
            packed_weight.weight.scale_mma,
            plan.handle,
...
@torch.library.custom_op(
    "b12x_next::blockscaled_packed_tensor_fp8",
    mutates_args=(),
)
...
def tensor_fp8_linear(
    ...
    *,
    ...
    if tokens == 0:
        ...
        output = torch.ops.b12x_next.blockscaled_packed_tensor_fp8(
            source_2d,
...
def blockscaled_mm(
    ...
    **kwargs: Any,
    ...
    if lhs_values.ndim == 2 or rhs_values.ndim == 2:
        ...
        return torch.ops.b12x_next.blockscaled_serialized(
            lhs_values,
            lhs_scale,
            rhs_values,
            rhs_scale,
    ...
    from b12x_next.gemm._preparation import mm as prepared_mm
