...
The FP6 surface lives in ``b12x_next.quantization.mxfp6``; FP4/NVFP4 support lives
elsewhere in ``b12x_next.quantization``.
"""
...
from b12x_next._lib.compiler import KernelCompileSpec, compile as b12x_compile
from b12x_next._lib.compile_plan import attach_programs
from b12x_next._lib.intrinsics import align_up
...
from b12x_next._lib.runtime_control import raise_if_kernel_resolution_frozen
from b12x_next.quantization.mxfp6.bf16_to_fp6_tma import TestKernel as FP6TestKernel
...
def compile_bf16_to_fp6_tma(
    ...
    ``(M,)`` f32 per-row scales from :func:`~b12x_next.quantization.mxfp6.
...
from b12x_next.quantization.mxfp6.fp6_moe_weights import (  # noqa: E402
    FP6MoEWeights,
    quantize_moe_weights_to_fp6,
    save_fp6_moe_weights,
    load_fp6_moe_weights,
)
from b12x_next.quantization.mxfp6.fp6_dense_weights import (  # noqa: E402
    FP6DenseWeight,
...
from b12x_next.quantization.mxfp6.fp6_checkpoint import (  # noqa: E402
    FP6LinearTensors,
...
from b12x_next.quantization.mxfp6.model_fp6 import (  # noqa: E402
    SafetensorsModel,
    MoEExpertScheme,
    DenseLinearScheme,
...
from b12x_next.quantization.mxfp6.fp6_safetensors_export import (  # noqa: E402
    ExportReport,
...
from b12x_next.quantization.mxfp6.fp6_safetensors_load import (  # noqa: E402
...
from b12x_next.quantization.mxfp6._preparation import (  # noqa: E402
    Mxfp6DenseConfig,
    Mxfp6DenseQuery,
    plan,
)
