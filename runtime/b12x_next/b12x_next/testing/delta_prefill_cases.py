...
from b12x_next.preparation import FrozenMapping, PreparationSession, PreparedCall
from b12x_next.sequence._shared.delta_prefill.preparation import invocation_from_tensors
...
def prefill_op(recipe: str):
    ...
    return importlib.import_module(f"b12x_next.sequence.{recipe}_prefill")
