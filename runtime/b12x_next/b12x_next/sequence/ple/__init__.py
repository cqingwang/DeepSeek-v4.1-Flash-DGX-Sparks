...
separate :mod:`b12x_next.sequence.ple_hash` op.
...
:mod:`b12x_next.sequence.ple.reference` and are not used as runtime fallbacks.
"""
...
META = OpMeta(
    ...
    provenance=Provenance(
        ...
        commit="3a437ab51680",
        paths=(
            "b12x_next/_lib/scratch.py",
            "b12x_next/_lib/scratch_layout.py",
        ),
    ),
