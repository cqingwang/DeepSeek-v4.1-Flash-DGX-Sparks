...
META = OpMeta(
    ...
    provenance=Provenance(repo="https://github.com/lukealonso/b12x_next", commit="79e228ec6",
                          paths=("b12x_next/sequence/kda_prefill/_cute_kernels.py",
                                 "b12x_next/sequence/gdn_decode/_cute_kernels.py")),
