...
class PreparationDisplay:
    ...
    def __init__(self, *, global_rank: int, stream=None, title="b12x_next / kernel autotuning", cancel_available=False):
    ...
    def _write_milestone(self):
        ...
        line = (
            f"b12x_next {phase}{component}: {p.completed_requests}/{p.total_requests} ready"
    ...
    def _render_line(self, frame, width):
        ...
        line = Text("b12x_next  ", style=f"bold {_INK}", no_wrap=True, overflow="ellipsis")
