...
from b12x_next.attention._shared.cute.ops import LOG2_E
...
from b12x_next._lib.intrinsics import shared_ptr_to_u32, st_shared_u32
...
_MLA_SM120_NUM_SPLITS_ENV = "B12X_NEXT_MLA_SM120_NUM_SPLITS"
...
_MLA_SM120_GLM_H8_NATIVE_ENV = "B12X_NEXT_MLA_SM120_GLM_H8_NATIVE"
...
_MLA_SM120_DSV4_H16_NATIVE_ENV = "B12X_NEXT_MLA_SM120_DSV4_H16_NATIVE"
...
def _env_num_splits_override() -> int:
    """Read ``B12X_NEXT_MLA_SM120_NUM_SPLITS`` per call. ``<= 0`` / unset / bad -> 0
...
def plan_unified_decode_splits(
    *,
    ...
    Override precedence (highest first):
      ...
      2. ``B12X_NEXT_MLA_SM120_NUM_SPLITS`` env (>=1 pins; <=0/unset -> heuristic).
...
def _cache_block_stride_bytes(
    ...
    *,
    ...
    from b12x_next.attention._shared.mla.compressed_reference import (
...
@torch.library.custom_op(
    "b12x_next::sparse_mla_sm120_decode_grid",
...
def compile_unified_decode_launch(
    *, prepared: UnifiedDecodeLaunch, **run_kwargs
    ...
    from b12x_next._lib.compile_plan import compile_only_launches
    ...
    *,
    ...
    def _launch_grid(grid_h_blocks: int, valid_hpb: int, head_block_offset: int):
        ...
        if compile_only_launches_enabled() or prepared is not None:
            ...
            return launched
        return torch.ops.b12x_next.sparse_mla_sm120_decode_grid(*args)
    ...
    from b12x_next.attention._shared.mla.api import _final_lse_from_split_workspace
