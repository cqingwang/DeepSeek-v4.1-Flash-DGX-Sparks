...
performs.  The FP4-path dequant primitives in ``b12x_next._lib.intrinsics``
...
@torch.library.custom_op("b12x_next::bmm_mxfp8", mutates_args=("out",))
def _op(
    lhs: torch.Tensor,
    b_values: torch.Tensor,
    b_scales: torch.Tensor,
...
@torch.library.custom_op(
    "b12x_next::mla_query_projection_mxfp8", mutates_args=("out",)
)
