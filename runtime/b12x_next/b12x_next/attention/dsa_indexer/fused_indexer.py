...
``b12x_next/attention/indexer/kernel.py`` (``_compute_mxfp8_tile_partials`` et al.)
and the radix select / virtual-index loaders from
``b12x_next/attention/indexer/tiled_topk.py``; nothing is reinvented here.
"""
...
from b12x_next._lib.intrinsics import shared_ptr_to_u32
...
from b12x_next.attention.dsa_indexer._tuning import (
    FUSED_MERGE_AUTO,
    FUSED_MERGE_CHOICES,
    FUSED_MERGE_COOPERATIVE,
    FUSED_MERGE_SERIAL,
)
from b12x_next.attention.dsa_indexer.persistent_topk import (
    _RADIX,
    _RADIX_THRESHOLD,
)
from b12x_next.attention.dsa_indexer.tiled_topk import (
    _SCAN_UNROLL,
    _SUPPORTED_TOPK,
...
from b12x_next._lib.intrinsics import ld_shared_f32
from b12x_next.attention.dsa_indexer.kernel import (
    _to_kernel_tensor,
...
# Triage kill-switch: B12X_NEXT_INDEXER_DIRECT_K=0 forces every variant back to
...
_DIRECT_K_SCORE_ENABLED = os.environ.get("B12X_NEXT_INDEXER_DIRECT_K", "1").lower() not in {
    "0",
    "false",
    "no",
    "",
