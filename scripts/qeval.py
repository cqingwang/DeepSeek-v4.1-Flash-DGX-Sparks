...
def ask(url, task, timeout):
    body = {"model": "deepseek-v4.1-flash", "temperature": 0, "max_tokens": task["max_tokens"],
            "stream": False, "chat_template_kwargs": {"thinking": bool(task["thinking"])},
...
if __name__ == "__main__":
    ...
    r.add_argument("--url", default="http://127.0.0.1:8888/v1/chat/completions")
