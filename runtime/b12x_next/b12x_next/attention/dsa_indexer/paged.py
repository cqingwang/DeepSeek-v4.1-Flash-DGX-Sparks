...
from b12x_next.attention.dsa_indexer._impl import (
    build_paged_mqa_schedule_metadata,
    uses_paged_mqa_schedule,
)
from b12x_next.attention.dsa_indexer.contiguous_kernel import (
...
from b12x_next._lib.compile_plan import launch_triton
...
_TWO_LEVEL_FOLD_MODE_ENV = "B12X_NEXT_INDEXER_TWO_LEVEL_FOLD"
_TWO_LEVEL_FOLD_MAX_MIB_ENV = "B12X_NEXT_INDEXER_TWO_LEVEL_FOLD_MAX_MIB"
_TWO_LEVEL_FOLD_MAX_MIB_DEFAULT = 256
from b12x_next.attention.dsa_indexer.reference import (
...
_PAGED_INDEX_SUPERTILE_K_ENV = "B12X_NEXT_PAGED_INDEX_SUPERTILE_K"
...
class IndexerPagedMetadata:
    ...
    should set it to the exact indexer-head count they pass to b12x_next. Replicated
...
def _validate_raw_page_lengths(
    *,
    ...
    if (
        ...
        and os.getenv("B12X_NEXT_VALIDATE_PAGED_INDEXER_CUDA_VALUES", "0") != "1"
    ):
        return
...
def index_topk_fp8(
    *,
    ...
    from b12x_next.attention.dsa_indexer.fused_indexer import (
