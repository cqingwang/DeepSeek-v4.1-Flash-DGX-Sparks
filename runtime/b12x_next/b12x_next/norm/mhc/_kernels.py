...
from b12x_next._lib.compiler import run_compiled
from b12x_next._lib.compile_plan import compile_only_launches_enabled
...
from b12x_next._lib.utils import current_cuda_stream
...
_PARTIALS = 1 + _MIXES
_PARTIALS_PER_CTA = 2
_MHC_PDL = os.getenv("B12X_NEXT_MHC_PDL", "0") != "0"
...
_THREADS = 128
_PREFILL_THREADS = int(os.getenv("B12X_NEXT_MHC_PREFILL_THREADS", "512"))
_PREFILL_GRAM_THREADS = int(
    os.getenv(
        "B12X_NEXT_MHC_PREFILL_GRAM_THREADS",
        os.getenv("B12X_NEXT_MHC_PREFILL_THREADS", "1024"),
    )
)
_PREFILL_BLOCK_M = 2
...
_PREFILL_TMA_COMPUTE_WARPS = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TMA_WARPS", "8")
)
_PREFILL_TMA_THREADS = (_PREFILL_TMA_COMPUTE_WARPS + 1) * 32
_PREFILL_TMA_TILE_M = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TMA_TILE_M", "128")
)
_PREFILL_TMA_TILE_N = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TMA_TILE_N", "16")
)
_PREFILL_TMA_TILE_K = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TMA_TILE_K", "64")
)
_PREFILL_TMA_STAGES = int(os.getenv("B12X_NEXT_MHC_PREFILL_TMA_STAGES", "3"))
_PREFILL_TF32_TMA_M_WARPS = int(
    os.getenv(
        "B12X_NEXT_MHC_PREFILL_TF32_TMA_M_WARPS",
        os.getenv(
            "B12X_NEXT_MHC_PREFILL_TF32_TMA_WARPS",
            os.getenv("B12X_NEXT_MHC_PREFILL_TMA_WARPS", "1"),
        ),
    )
)
_PREFILL_TF32_TMA_N_WARPS = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_N_WARPS", "1")
)
...
_PREFILL_TF32_TMA_TILE_M = int(
    os.getenv(
        "B12X_NEXT_MHC_PREFILL_TF32_TMA_TILE_M",
        os.getenv("B12X_NEXT_MHC_PREFILL_TMA_TILE_M", "16"),
    )
)
_PREFILL_TF32_TMA_TILE_N = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_TILE_N", "8")
)
_PREFILL_TF32_TMA_TILE_K = int(
    os.getenv(
        "B12X_NEXT_MHC_PREFILL_TF32_TMA_TILE_K",
        os.getenv("B12X_NEXT_MHC_PREFILL_TMA_TILE_K", "256"),
    )
)
_PREFILL_TF32_TMA_STAGES = int(
    os.getenv(
        "B12X_NEXT_MHC_PREFILL_TF32_TMA_STAGES",
        os.getenv("B12X_NEXT_MHC_PREFILL_TMA_STAGES", "1"),
    )
)
_PREFILL_TF32_TMA_CHUNK_MIN_TOKENS = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_CHUNK_MIN_TOKENS", "4096")
)
_PREFILL_TF32_TMA_LONG_MIN_TOKENS = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_LONG_MIN_TOKENS", "8192")
)
...
_PREFILL_TF32_TMA_CHUNK_4096_M_WARPS = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_CHUNK_M_WARPS", "12")
)
_PREFILL_TF32_TMA_CHUNK_OTHER_M_WARPS = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_CHUNK_M_WARPS", "2")
)
_PREFILL_TF32_TMA_CHUNK_4096_N_WARPS = int(
    os.getenv(
        "B12X_NEXT_MHC_PREFILL_TF32_TMA_CHUNK_N_WARPS",
        os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_N_WARPS", "1"),
    )
)
...
_PREFILL_TF32_TMA_CHUNK_4096_TILE_M = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_CHUNK_TILE_M", "192")
)
_PREFILL_TF32_TMA_CHUNK_OTHER_TILE_M = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_CHUNK_TILE_M", "32")
)
_PREFILL_TF32_TMA_CHUNK_4096_TILE_N = int(
    os.getenv(
        "B12X_NEXT_MHC_PREFILL_TF32_TMA_CHUNK_TILE_N",
        os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_TILE_N", "24"),
    )
)
...
_PREFILL_TF32_TMA_CHUNK_4096_TILE_K = int(
    os.getenv(
        "B12X_NEXT_MHC_PREFILL_TF32_TMA_CHUNK_TILE_K",
        os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_TILE_K", "64"),
    )
)
_PREFILL_TF32_TMA_CHUNK_4096_STAGES = int(
    os.getenv(
        "B12X_NEXT_MHC_PREFILL_TF32_TMA_CHUNK_STAGES",
        os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_STAGES", "2"),
    )
)
...
_PREFILL_TF32_TMA_LONG_4096_M_WARPS = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_LONG_M_WARPS", "8")
)
_PREFILL_TF32_TMA_LONG_4096_N_WARPS = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_LONG_N_WARPS", "1")
)
_PREFILL_TF32_TMA_LONG_4096_TILE_M = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_LONG_TILE_M", "128")
)
_PREFILL_TF32_TMA_LONG_4096_TILE_N = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_LONG_TILE_N", "24")
)
_PREFILL_TF32_TMA_LONG_4096_TILE_K = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_LONG_TILE_K", "64")
)
_PREFILL_TF32_TMA_LONG_4096_STAGES = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_TF32_TMA_LONG_STAGES", "2")
)
_PREFILL_FINALIZE_THREADS = int(
    os.getenv("B12X_NEXT_MHC_PREFILL_FINALIZE_THREADS", "256")
)
_POST_PRE_CHUNK = 12
...
def _validate_post_pre_partials_per_cta(partials_per_cta: int) -> int:
    ...
    if partials_per_cta <= 0 or partials_per_cta > _PARTIALS:
        raise ValueError(
            "B12X_NEXT_MHC_PARTIALS_PER_CTA must be in "
