...
from b12x_next.moe._shared.execution import MoEWeightPreparationPlan
...
# b12x_next/integration/. The prepared-weights payload plumbing they share should
...
def _run_bound_ep_moe(binding: EPMoEFP4Binding) -> torch.Tensor:
    ...
    from b12x_next.moe._shared.kernels.w4a16.kernel import run_w4a16_moe
