...
Example::
    ...
    torchrun --standalone --nproc-per-node=8 \
      -m b12x_next.comm.pcie.overlap_probe \
...
class CollectiveOverlapProbe:
    def __init__(self, config: ProbeConfig) -> None:
        ...
        from b12x_next.comm.pcie import DmaAllReduce
    ...
    def _initialize_query_split(self) -> None:
        from b12x_next.attention.dsa_indexer.paged import (
            index_topk_fp8,
            prepare_paged_indexer_metadata,
        )
        from b12x_next.attention.dsa_indexer.scratch import (
        ...
        from b12x_next.attention.dsa_indexer.tiled_topk import run_row_topk
...
def run_probe(config: ProbeConfig) -> dict[str, Any] | None:
    ...
    result: dict[str, Any] = {
        ...
        "topology": topology,
        "provenance": {
            "command": os.getenv("B12X_NEXT_PROBE_COMMAND", ""),
            "source_revision": os.getenv("B12X_NEXT_PROBE_SOURCE_REVISION", ""),
            "source_worktree": os.getenv("B12X_NEXT_PROBE_SOURCE_WORKTREE", ""),
