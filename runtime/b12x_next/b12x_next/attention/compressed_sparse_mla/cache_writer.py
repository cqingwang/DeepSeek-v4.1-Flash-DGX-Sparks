...
def page_nbytes(
    ...
    *,
    ...
    from b12x_next.attention._shared.mla.kv_cache import page_nbytes as _page_nbytes
    ...
    *,
    ...
    def jobs(_config, detected):
        return (CompileJob.create(
            "b12x_next.attention.compressed_sparse_mla.cache_writer:compile_cache_writer",
