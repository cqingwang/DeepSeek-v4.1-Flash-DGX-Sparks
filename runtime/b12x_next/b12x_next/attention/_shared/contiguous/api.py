    ...
    def __init__(
        ...
        *,
        ...
        if not ContiguousAttentionForwardKernel.can_implement(
            ...
            raise TypeError(
                "b12x_next attention launch is unsupported with "
    ...
    def __init__(
        ...
        *,
        ...
        if not ContiguousAttentionForwardKernel.can_implement(
            ...
            raise TypeError(
                "b12x_next varlen attention launch is unsupported with "
                f"dtype={dtype}, q_shape={q_shape}, k_shape={k_shape}, v_shape={v_shape}, "
...
def clear_attention_caches() -> None:
    """Clear global compile caches owned by the b12x_next attention integration."""
