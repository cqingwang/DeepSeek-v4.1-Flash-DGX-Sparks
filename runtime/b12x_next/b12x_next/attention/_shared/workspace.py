...
class B12XAttentionArena:
    ...
    def make_mhc_workspace(self):
        ...
        from b12x_next.norm.mhc._impl import MHCWorkspace
...
class B12XAttentionWorkspace:
    ...
    def bind_compressed_sparse_mla(
        ...
        *,
        ...
        from b12x_next.attention.compressed_sparse_mla._scratch import (
    ...
    def bind_sparse_mla(
        ...
        *,
        ...
        from b12x_next.attention.sparse_mla._scratch import (
    ...
    def _refresh_ragged_kv_contracts(self) -> None:
        ...
        from b12x_next.attention._shared.mla.packed import (
