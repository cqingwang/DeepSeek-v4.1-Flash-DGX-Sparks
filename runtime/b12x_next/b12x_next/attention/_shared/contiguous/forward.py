...
from b12x_next.attention._shared.cute import ops as cute_ops
from b12x_next.attention._shared.cute import (
    pipeline as cute_pipeline,
)
from b12x_next.attention._shared.contiguous import layout_utils
from b12x_next.attention._shared.contiguous.cute_dsl_utils import (
    assume_tensor_aligned,
)
from b12x_next.attention._shared.contiguous.mask import (
    AttentionMask,
)
from b12x_next.attention._shared.contiguous.softmax import Softmax
from b12x_next.attention._shared.contiguous.seqlen_info import (
    SeqlenInfoQK,
)
from b12x_next.attention._shared.contiguous.block_info import (
    BlockInfo,
)
from b12x_next.attention._shared.contiguous.pack_gqa import (
    PackGQA,
    pack_gqa_layout,
)
from b12x_next.attention._shared.contiguous.named_barrier import (
    NamedBarrierFwd,
)
from b12x_next.attention._shared.contiguous.tile_scheduler import (
    SingleTileScheduler,
...
class ContiguousAttentionForwardKernel:
    ...
    def __init__(
        ...
        assert self.score_mod is None, (
            "score_mod is not part of the initial b12x_next transplant"
        )
        assert self.mask_mod is None, (
            "mask_mod is not part of the initial b12x_next transplant"
        )
