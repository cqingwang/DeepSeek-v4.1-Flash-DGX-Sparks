...
@torch.library.custom_op(
    "b12x_next::concat_and_cache_glm_next_mla",
...
def concat_and_cache_glm_next_mla(
    ...
    *,
    ...
    from b12x_next.attention.sparse_mla._preparation import writer_state
...
@torch.library.custom_op(
    "b12x_next::concat_and_cache_nvfp4_mla_fp8_rope",
    mutates_args=("kv_cache",),
)
...
@torch.library.custom_op(
    "b12x_next::concat_and_cache_glm_next_nvfp4_mla",
    mutates_args=("kv_cache",),
)
...
def concat_and_cache_nvfp4_mla_fp8_rope(
    ...
    torch.ops.b12x_next.concat_and_cache_nvfp4_mla_fp8_rope(
        kv_c, k_pe, kv_cache, slot_mapping, per_token_scale
    )
