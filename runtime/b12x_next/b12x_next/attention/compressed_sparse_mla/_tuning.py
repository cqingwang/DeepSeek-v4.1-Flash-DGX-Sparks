...
def _single_pass(query: SparseMlaQuery, device: DeviceIdentity | None) -> bool:
    from b12x_next.attention._shared.mla.compressed_api import _should_use_sm121_single_pass_decode
...
def _split_config(query: SparseMlaQuery, max_chunks: int):
    from b12x_next.attention._shared.mla.compressed_config import compressed_sparse_mla_split_config_for_contract
...
def _validate_config(
    ...
    from b12x_next.attention._shared.mla.compressed_config import (
