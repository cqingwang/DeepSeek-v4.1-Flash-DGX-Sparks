...
def plan(query: PcieQuery, *, runtime=None, invocation=FrozenMapping(), override: PcieConfig | None = None) -> Plan:
    ...
    return Plan(
        ...
        _compile_jobs=lambda config, device: (CompileJob.create("b12x_next.comm.pcie._dcp_preparation:compile_dcp_surface", TUNING.encode_query(query), device.ordinal),),
