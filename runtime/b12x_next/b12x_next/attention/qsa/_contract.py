...
def plan(
    ...
    return Plan(
        ...
        _compile_jobs=lambda config, device: (CompileJob.create(
            "b12x_next.attention.qsa._contract:compile_qsa",
...
@torch.library.custom_op("b12x_next::qsa_attention", mutates_args=("scratch", "output"))
