...
from b12x_next._lib.compile_plan import attach_programs, compile_only_launches, load_programs, program_keys
from b12x_next._lib.compiler import observe_launchers
...
def _lower_launch(
    ...
    *,
    ...
    from b12x_next.attention._shared.mla.kernel import (
        compile_unified_decode_launch,
        prepare_unified_decode_launch,
    )
    from b12x_next.attention._shared.mla.traits import (
        ComputeMode,
        ModelType,
        ScaleFormat,
        make_unified_traits,
...
def _lower_prefill_launch(
    ...
    from b12x_next.attention._shared.mla.prefill import run_unified_prefill
    from b12x_next.attention._shared.mla.traits import (
        ComputeMode,
        ModelType,
        ScaleFormat,
...
def _lower_indexed_mapper(
    ...
    if query.cache_format != "deepseek_v41" or not query.indexed_cache_present:
        return None
    from b12x_next.attention.compressed_sparse_mla._metadata import map_indexed_pages
...
class _PreparedCompressedSparseMla:
    ...
    def run(self, binding: B12XCompressedSparseMLABinding, **kwargs):
        from b12x_next.attention._shared.mla.compressed_api import compressed_sparse_mla_decode_forward
...
def plan(caps: B12XCompressedSparseMLAScratchCaps, *, invocation=FrozenMapping(), override=None) -> Plan:
    ...
    def compile_jobs(config, device):
        return (CompileJob.create(
            "b12x_next.attention.compressed_sparse_mla._preparation:compile_compressed_sparse_mla",
