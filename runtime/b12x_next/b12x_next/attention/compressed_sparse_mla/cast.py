...
from b12x_next._lib.compiler import KernelCompileSpec, compile as compile_cute, run_compiled
...
from b12x_next.preparation import FrozenMapping, MemoryRequirements, Plan, make_fixed_contract
...
def plan(query: Query, *, device, invocation=FrozenMapping(), override=None):
    ...
    def jobs(config, detected):
        return (CompileJob.create(
            "b12x_next.attention.compressed_sparse_mla.cast:compile_cast",
...
@torch.library.custom_op("b12x_next::compressed_mla_cast", mutates_args=("out",))
