...
#include <fcntl.h>
#include <time.h>
#ifdef B12X_NEXT_HAVE_LIBURING
#include <liburing.h>
#endif

#include "_row_plan.h"
#define PLE_CAPSULE "b12x_next.ple_reader"
...
static PyObject *py_ple_reader(PyObject *self, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, "LLLLLLLi", &shard_rows, &padded_rows,
                          ...
                          &depth)) return NULL;
#ifndef B12X_NEXT_HAVE_LIBURING
    return PyErr_Format(PyExc_RuntimeError,
                        "io_uring PLE support is unavailable: install liburing development headers and pkg-config, then rebuild the b12x_next native loader");
#else
