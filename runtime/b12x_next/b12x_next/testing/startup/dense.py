...
from b12x_next.preparation import PreparationRequest, PreparedCall
...
def _prepare_weight(k: int, n: int, recipe: str, device: torch.device):
    ...
    from b12x_next.gemm.blockscaled import api
    ...
    if padded != k:
        source[:, k:].zero_()
    if recipe == "nvfp4_a16":
        from b12x_next.quantization.nvfp4 import api as quant
    ...
    from b12x_next._lib.intrinsics import as_grouped_scale_view_mx
    from b12x_next.quantization import mxfp8
...
def _packed_query(k: int, n: int, m: int, recipe: str):
    from b12x_next.gemm.blockscaled import BlockscaledQuery
...
def make_benchmark_requests(
    ...
    from b12x_next.gemm.bf16_gemv import api as gemv
    from b12x_next.gemm.bf16_vocab_projection import api as vocab
    from b12x_next.gemm.blockscaled import api as packed
