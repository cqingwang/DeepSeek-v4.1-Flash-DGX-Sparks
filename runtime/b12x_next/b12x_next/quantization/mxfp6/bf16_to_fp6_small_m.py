...
The TMA quantizer (:mod:`b12x_next.quantization.mxfp6.bf16_to_fp6_tma`) tiles
...
fmt-aware numerator from :func:`b12x_next._lib.fp6.mx_gs_numerator`); thread 0
...
# path in b12x_next.quantization.mxfp6.fp6_dense_weights.
