...
def plan(query: GemvQuery, *, invocation=FrozenMapping(), override=None) -> Plan:
    ...
    def compile_jobs(config, device):
        ...
        return (CompileJob.create(
            "b12x_next.gemm.bf16_gemv._preparation:compile_gemv",
...
@torch.library.custom_op("b12x_next::bf16_gemv_small_n", mutates_args=())
...
@torch.library.custom_op("b12x_next::bf16_gemv_small_n_out", mutates_args=("out",))
