"""Private implementation package for :func:`b12x_next.gemm.bmm`.
...
META = OpMeta(
    ...
    provenance=Provenance(
        repo="https://github.com/MadeBy561/b12x_next",
        commit="3854a4b1",
        paths=("b12x_next/gemm/qbmm_absorb.py",),
    ),
