...
class PagedForwardKernel:
    ...
    def __init__(
        ...
        *,
        ...
        base_use_paged_kv_tma_extend = (
            enable_paged_kv_tma
            and paged_control("B12X_NEXT_PAGED_KV_TMA", "1") != "0"
        ...
        self.use_qwen_fp8_qk_quarter_repack = (
            paged_control("B12X_NEXT_PAGED_EXTEND_QWEN_FP8_QK_QUARTER_REPACK", "1")
            != "0"
            and self.kv_is_fp8
            and dtype_q == cutlass.BFloat16
            and dtype_o == cutlass.BFloat16
        ...
        fp8_pv_repack_env = os.environ.get(
            "B12X_NEXT_PAGED_EXTEND_QWEN_FP8_PV_REPACK"
        )
    ...
    def kernel(
        ...
        use_compact_dense_bf16_mask = const_expr(
            ...
            and self.window_left < 0
            and self.traits.num_warps_kv == 1
            and paged_control("B12X_NEXT_PAGED_EXTEND_COMPACT_MASK", "1") != "0"
        )
...
def build_extend_forward_kernel(
    ...
    *,
    ...
    enable_paged_kv_tma = (
        paged_control("B12X_NEXT_PAGED_KV_TMA", "1") != "0"
    )
