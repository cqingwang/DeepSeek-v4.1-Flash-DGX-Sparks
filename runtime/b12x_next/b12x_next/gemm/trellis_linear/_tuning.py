...
from b12x_next.preparation import Knob, ParameterBinding, TuningContract
...
def default_config(query, device):
    from b12x_next.moe._shared.kernels.w4a16.kernel import _trellis256_dense_launch_geometry
