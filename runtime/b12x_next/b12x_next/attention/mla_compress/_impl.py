...
from b12x_next.sequence.ple_hash._contracts import _require_mutation_alias_contract
...
@torch.library.register_fake("b12x_next::mla_compress_ratio1")
...
@torch.library.register_fake("b12x_next::mla_compress_ratio2")
