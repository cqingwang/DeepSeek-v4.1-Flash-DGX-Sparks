...
from b12x_next._lib.compiler import launch as b12x_launch, run_compiled
...
def _sparse_mla_prefill_mg_flat_launch(
    ...
    *,
    ...
    pack_hilo_rows = (
        ...
        and int(mg_n_hg) == 1
        and valid_hpb == 8
        and os.environ.get("B12X_NEXT_MLA_SM120_PREFILL_PACK_HILO_ROWS", "1")
...
@torch.library.custom_op(
    "b12x_next::sparse_mla_sm120_prefill_mg",
...
@torch.library.custom_op(
    "b12x_next::sparse_mla_sm120_prefill_mg_dual",
    mutates_args=("output", "lse_out"),
)
    ...
    *,
    ...
    if has_extra:
        ...
        if (
            ...
            torch.ops.b12x_next.sparse_mla_sm120_prefill_mg_dual(
    ...
    if (
        ...
        torch.ops.b12x_next.sparse_mla_sm120_prefill_mg(
            q,
