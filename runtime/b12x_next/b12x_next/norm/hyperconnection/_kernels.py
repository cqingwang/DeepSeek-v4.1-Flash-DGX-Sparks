...
@torch.library.custom_op("b12x_next::hyperconnection_grouped_rmsnorm", mutates_args=("out",))
...
@torch.library.custom_op("b12x_next::hyperconnection_scaled_silu", mutates_args=("out",))
def _scaled_silu_op(
...
@torch.library.custom_op("b12x_next::hyperconnection_gate_mean", mutates_args=("out",))
def _gate_mean_op(
...
@torch.library.custom_op("b12x_next::hyperconnection_combine", mutates_args=())
def _combine_op(
...
@torch.library.custom_op("b12x_next::hyperconnection_combine_norm", mutates_args=())
...
@torch.library.custom_op("b12x_next::hyperconnection_engram_mix", mutates_args=("out",))
def _engram_mix_op(
...
@torch.library.custom_op("b12x_next::hyperconnection_swiglu", mutates_args=("out",))
def _swiglu_op(
...
@torch.library.custom_op("b12x_next::hyperconnection_add", mutates_args=("out",))
def _add_op(
...
@torch.library.custom_op("b12x_next::hyperconnection_sigmoid", mutates_args=("out",))
