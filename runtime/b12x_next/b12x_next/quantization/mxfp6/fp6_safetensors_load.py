"""Load a b12x_next MX-FP6 (W6A6) safetensors checkpoint into kernel-ready weights.

Read side of :mod:`b12x_next.quantization.mxfp6.fp6_safetensors_export`. Given
the per-expert ModelOpt-mirror keys (``.weight`` / ``.weight_scale`` /
``.weight_scale_2`` / ``.input_scale``), this reconstructs the exact
:class:`~b12x_next.quantization.mxfp6.fp6_moe_weights.FP6MoEWeights` layout
