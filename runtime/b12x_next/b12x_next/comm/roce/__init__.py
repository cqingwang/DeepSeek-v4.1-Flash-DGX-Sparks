"""``b12x_next.comm.roce`` (RoCEnante): one-shot all-reduce and all-gather over RoCE for multi-node TP.
...
META = OpMeta(
    ...
    provenance=Provenance(
        repo="https://github.com/local-inference-lab/b12x_next",
        commit="b9e450f1",
        paths=("b12x_next/comm/roce/",),
    ),
