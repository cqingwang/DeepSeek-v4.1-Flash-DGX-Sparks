...
from b12x_next._lib.compile_plan import attach_programs, compile_only_launches_enabled
...
def _turbo_attention_enabled() -> bool:
    return paged_control("B12X_NEXT_TURBO_ATTN") == "1"
...
def _encode_plane_tma_descriptors(
    ...
    *,
    ...
    swizzle_name = os.environ.get("B12X_NEXT_PAGED_KV_TMA_PLANE_SWIZZLE", "")
    swizzle = (
