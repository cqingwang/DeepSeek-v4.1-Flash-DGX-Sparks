...
from b12x_next.preparation.types import (
    FrozenMapping,
    MemoryRequirements,
...
class _StridedState:
    ...
    def prime(self, binding: Binding):
        from b12x_next.attention._shared.static_fp8_quant import resolve_static_fp8_quant_launcher
        from b12x_next.attention.dense_mla._kernel import resolve_dense_mla_launchers
        object.__setattr__(
    ...
    *,
    ...
    return PreparationPlan(
        ...
        _compile_jobs=lambda config, device: (CompileJob.create(
            "b12x_next.attention.sparse_mla.strided:compile_strided_sparse_mla",
            caps,
            device.ordinal,
        ),),
