...
from b12x_next.sequence.ple_hash._preparation import (
...
from b12x_next.sequence.ple_hash._tuning import PleHashQuery, TUNING as HASH_TUNING
from b12x_next.sequence.ple_hash.geometry import _GeometryInputs
...
def make_plan(caps, *, geometry, prime_sizes, table_offsets, multipliers, invocation, override):
    ...
    def compile_jobs(config, device):
        return (CompileJob.create(
            "b12x_next.sequence.ple_embedding._preparation:compile_embedding",
